...
if(
 ...
 {
    $sql="UPDATE don SET nom_don=?,categorie_id=?,sous_categorie_id=?,
    sous_sous_categorie_id=?,sous_sous_sous_categorie_id=?,quantite_don=?,prix_unitaire=?  WHERE id=?" ;
    $req=$connexion->prepare($sql);
    $req->execute(array( $nom_don,$category,$sub_category,$sub_sub_category,$sub_sub_sub_category,$quantite_don,$prix_unitaire,$_POST['id']
